...
import 'package:invoice/models/custom_data.dart';
...
Future<Uint8List> generateInvoice() async {
  ...
  final invoice = Invoice(
    ...
    products: products,
    customerName: 'Nganga Chege',
    customerAddress: '54 Nairobi\nKenya',
    paymentInfo:
        '4509 Biashara Street Street\Naribi, Kenya(KE), 37929\n865-372-0425',
    tax: .15,
...
class Invoice {
  ...
  Future<Uint8List> buildPdf() async {
    ...
    final profileImage = pw.MemoryImage(
      (await rootBundle.load('assets/filtronic.png')).buffer.asUint8List(),
    );
    ...
    doc.addPage(
      pw.MultiPage(
        ...
        header: (context) => _buildHeader(context, profileImage),
        footer: _buildFooter,
        build: (context) => [
  ...
  pw.Widget _buildHeader(pw.Context context, MemoryImage profileImage) {
    return pw.Column(
      children: [
        pw.Row(
